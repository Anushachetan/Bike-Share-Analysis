...
# 
# **Answer**: Q1. What is the total number of bikes and stations available (Details of bikes and stations)
#             Q2. What is the number of users use bike (Details of bike users)
# 
...
def number_of_trips(filename):
    ...
    with open(filename, 'r') as f_in:
        ...
        sub_proportion=(n_subscribes/n_total)*100
        cus_proportion=(n_subscribes/n_total)*100
...
customers=trips_times.query('user_type=="Customer"')
customers2=customers.query('duration<75')
duration=customers2['duration']
bins=py.arrange(0,75,5)
plt.hist(duration,bins)
locations=bins+5
labels=['5','10','20','25','30','35','40','45','50','55','60','65','70','75']
